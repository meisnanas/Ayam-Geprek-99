...
root.resizable(0,0)
root.title("Ayam Geprek 99 Cashier")  # nama aplikasi

topFrame=Frame(root,bd=20,relief=RIDGE,bg='white')  # frame judul
topFrame.pack(side=TOP)

labelTitle=Label(topFrame,text='Ayam Geprek 99',font=('Castellar',38,'bold'),fg="#ffffff",bg="#cbae57", bd=15,width=30)  # judul aplikasi
labelTitle.grid(row=0,column=10)

root.config(bg="#cbae57")  # warna dasar / background
...
var6=IntVar()
var7=IntVar()
var8=IntVar()  # Tambahan untuk es teler
...
e_esteler=StringVar()  # Tambahan untuk es teler
...
def totalcost():
    ...
    if var1.get() != 0 or var2.get() != 0 or var3.get() != 0 or var4.get() != 0 or var5.get() != 0 or var6.get() != 0 or var7.get() != 0 or var8.get() != 0:  # Tambah var8
...
def reset():
    ...
    textesteler.config(state=DISABLED)  # Tambahan
...
ayamgeprekFrame = LabelFrame(menuFrame, text=' Ayam Geprek ', font=('Castellar', 19, 'bold'), bd=10, relief=RIDGE, fg="#4b5125", bg='#f6f6f6')
ayamgeprekFrame.pack(side=LEFT)

minumanFrame = LabelFrame(menuFrame, text=' Minuman ', font=('Castellar', 19, 'bold'), bd=10, relief=RIDGE, fg="#4b5125", bg='#f6f6f6')
minumanFrame.pack(side=RIGHT)
# batas frame kiri (menu cafe)

# membuat tampilan daftar menu ayam geprek
ayamgeprekoriginal = Checkbutton(ayamgeprekFrame, text=' Ayam Geprek Original (Rp20000) ', font=('Calibri', 16, 'bold'), onvalue=1, offvalue=0, variable=var1,
                        command=ayamgeprekoriginal, bg='#f6f6f6')
ayamgeprekoriginal.grid(row=0, column=0, sticky=W)

ayamgepreksambalijo = Checkbutton(ayamgeprekFrame, text=' Ayam Geprek Sambal Ijo (Rp22000) ', font=('Calibri', 16, 'bold'), onvalue=1, offvalue=0, variable=var2,
                        command=ayamgepreksambalijo, bg='#f6f6f6')
ayamgepreksambalijo.grid(row=1, column=0, sticky=W)

ayamgeprekmozzarela = Checkbutton(ayamgeprekFrame, text=' Ayam Geprek Mozzarela (Rp30000) ', font=('Calibri', 16, 'bold'), onvalue=1, offvalue=0, variable=var3,
                        command=ayamgeprekmozzarela, bg='#f6f6f6')
ayamgeprekmozzarela.grid(row=2, column=0, sticky=W)

ayamgepreksambalmatah = Checkbutton(ayamgeprekFrame, text=' Ayam Geprek Sambal Matah (Rp22000) ', font=('Calibri', 16, 'bold'), onvalue=1, offvalue=0, variable=var4,
...
textayamgeprekoriginal = Entry(ayamgeprekFrame, font=('Calibri', '16', 'bold'), bd=7, width=8, state=DISABLED, textvar=e_ayamgeprekoriginal)
textayamgeprekoriginal.grid(row=0, column=1)

textayamgepreksambalijo = Entry(ayamgeprekFrame, font=('Calibri', '16', 'bold'), bd=7, width=8, state=DISABLED, textvar=e_ayamgepreksambalijo)
textayamgepreksambalijo.grid(row=1, column=1)

textayamgeprekmozzarela = Entry(ayamgeprekFrame, font=('Calibri', '16', 'bold'), bd=7, width=8, state=DISABLED, textvar=e_ayamgeprekmozzarela)
textayamgeprekmozzarela.grid(row=2, column=1)

textayamgepreksambalmatah = Entry(ayamgeprekFrame, font=('Calibri', '16', 'bold'), bd=7, width=8, state=DISABLED, textvar=e_ayamgepreksambalmatah)
...
esteler = Checkbutton(minumanFrame, text='Es Teler (Rp7000)', font=('Calibri', 16, 'bold'), onvalue=1, offvalue=0, variable=var8,  # Tambahan
